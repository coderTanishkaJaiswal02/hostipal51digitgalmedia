          ...
          <div className="min-w-full">
            <table className="w-full border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-2 sm:px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-12">#</th>
                  <th className="px-2 sm:px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Name</th>
                  <th className="hidden md:table-cell px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
                  <th className="px-2 sm:px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Role</th>
                  <th className="px-2 sm:px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                  <th className="px-2 sm:px-3 md:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredUsers.map((user, index) => (
                  <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                    {/* Index */}
                    <td className="px-2 sm:px-3 md:px-6 py-4 text-sm text-gray-900">{index + 1}</td>
                    ...
                    <td className="px-2 sm:px-3 md:px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 sm:ml-3">
                          ...
                          <div className="md:hidden text-xs text-gray-500 truncate mt-0.5">{user.email}</div>
                        </div>
                      </div>
                    </td>

                    {/* Email */}
                    <td className="hidden md:table-cell px-3 md:px-6 py-4 text-sm text-gray-900 truncate">{user.email}</td>
                    ...
                    <td className="px-2 sm:px-3 md:px-6 py-4 text-center">
                      <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center px-2 sm:px-3 py-1 border border-blue-300 text-xs font-medium rounded-md text-blue-700 bg-blue-50 hover:bg-blue-100 transition"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-2 sm:px-3 py-1 bg-red-500 text-white text-xs font-medium rounded-md hover:bg-rose-600 transition"
                        >
